    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <ul class="navbar-nav mr-auto">
            <form class="form-inline mr-auto ">
                ...
                <button class="btn btn-secondary my-2 my-sm-0" style="padding:9px;padding-left:15px;padding-right:15px;" type="submit"> i class="fa fa-envelope" aria-hidden="true"</button>
            </form>
